    ...
    return (
        <div className="w-full flex gap-5 h-[150px] rounded-lg border-1 border-solid bg-[#FFF] relative p-2.5">
            <div className="w-32 h-full ">
                ...
                <div className="flex h-full">
                    <div onClick={handleStoryModal}
                         className="object-cover text-center h-full border w-full p-[10px] rounded-[5px]">
                        <b>Crate Story</b>
                    </div>
            ...
            <div className="flex h-full w-32">
                {(registeredUser.stories?.photoStoryList?.length > 0 || registeredUser?.stories?.textStoryList?.length > 0) &&
